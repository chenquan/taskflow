...
The CLI MUST use exit code 0 for success, 1 for execution failure, 2 for argument or configuration errors, 3 for environment-preflight failure, 4 for partial completion, 5 for lock or active-session conflict, 6 for external-tool incompatibility, and 7 for validation failure.
