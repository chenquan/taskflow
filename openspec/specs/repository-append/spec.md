...
Define append-only repository growth for an existing task, including phase and lock gating, the atomic configuration-digest migration that preserves existing work, and stale validation reporting.
