...
- Copy exactly the paths declared in a per-repository `.taskflowcopy` whitelist into newly created worktrees; nothing else.
...
### 2. `.taskflowcopy` at the source repository root, required for new worktrees
