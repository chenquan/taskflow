...
#### Scenario: Preserve a child exit code as data
- **WHEN** an enabled development tool exits with a non-zero code
- **THEN** specflow exits with code 1 and reports the actual child code in result data
